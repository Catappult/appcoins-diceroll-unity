...
namespace UnityAppCoinsSDK
{
    ...
    public class AptoideBillingSDKManager : MonoBehaviour
    {
        ...
        string publicKey, string gameObjectName)
        {
            ...
            if (Application.platform == RuntimePlatform.Android)
            {
                ...
                Initialize(publicKey, gameObjectName);
                StartConnection();
            }
        }
        ...
        public static void Initialize(string publicKey, string gameObjectName)
        {
            aptoideBillingSDKUnityBridge?.CallStatic("initialize", gameObjectName, publicKey);
        }
        ...
        public void OnSkuDetailsResponse(string skuDetailsResultJson)
        {
            ...
            skuDetailsResponseListener.OnSkuDetailsResponse(skuDetailsResult.responseCode, skuDetailsResult.skuList);
        }
